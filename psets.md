...
| 11 | March 31st - April 3rd | [PSet 11]({{ site.baseurl }}/psets/PS10.pdf) ([*Solutions*]({{ site.baseurl }}/psets/PS11-Soln.pdf)) | [A Putnam Problem]({{ site.baseurl }}/psets/PS11-Extra.pdf) <br> [Midterm 2 Resources]({{ site.baseurl }}/psets.html#midterm-2) |
...
| <span id="midterm-2">Midterm 2</span> | April 15 | [Review Set 2]({{ site.baseurl }}/psets/MT-2.pdf) (*Solution*) <br> [Review Slides]({{ site.baseurl }}/psets/Midterm-2-Slides.pdf) | April 12 @ 12pm <br> <a onclick="alert(`<img src='{{ site.baseurl }}/assets/map/latrobe.png' style='max-width: 85%'><br>Hodson 301 is located at the star location (F2).`)"><u>Hodson 301</u></a> |
