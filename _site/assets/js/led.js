...
const messages = [
    ...
    `If you find any questions, please contact us via <a href='${base}/contacts.html'>Contacts</a> tab.`,
    `Often check out the <a href='${base ? 'https://jhu-ode-pilot.github.io' + base : ''}/#announcements'>announcements</a> for the newest updates about PILOT.`,
    `There are a lot of useful resources located at the <a href='${base}/resources.html'>Resources</a> tab.`
];
