...
function disablePage() {
    ...
    topnav.innerHTML = `<span class="logo"> <img src="${window.BASEURL || ''}/img/logo.png" style="vertical-align: middle; height: 25px; width: 25px" alt="logo"></span> &nbsp; PILOT Learning for <i>Differential Equations</i> &nbsp; &nbsp; Exam Mode`;
};